...
<body>
    <header
        ...
        <ul class="order-1 sm:order-2 hidden sm:flex gap-8 justify-between items-center whitespace-nowrap">
            <li class="cursor-pointer hover:text-sunset"><a href="/sign-up"> Sign up </a></li>
            <li class="cursor-pointer hover:text-sunset"><a href="/log-in">Log in</a></li>
        </ul>

        {{-- When search bar open remove hambuger menu and logo PicShare of website --}}
        ...
        <div id="hamburgerMenu" aria-hidden="true"
            class="block sm:hidden fixed top-0 right-0 left-0 z-50 bg-shadow bg-opacity-40 backdrop-blur-sm	transition-all">
            ...
            <div class="bg-sunset rounded-br-lg shadow h-screen w-1/2">
                ...
                <div class="p-6">
                    <ul class="text-black">
                        ...
                        <li class="cursor-pointer hover:text-shadow"><a href="/log-in">Log in</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <a href="/" class="order-3 sm:order-1 flex-none sm:flex-1 font-bold text-4xl">PicShare</a>
        <form class="flex items-center gap-2 order-4 sm:order-4 w-full">
    ...
    <footer class="bg-black text-white transition-all">
        ...
        <div class="py-6 px-4 md:flex md:items-center md:justify-between">
            ...
            <div class="flex mt-4 space-x-6 sm:justify-center md:mt-0">
                <a href="#" class=" hover:text-sunset">
