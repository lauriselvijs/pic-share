<header
    class="h-20 md:h-10 px-6 md:px-40 bg-black text-base font-normal text-white flex gap-8 justify-start md:justify-end items-center transition-all"
    x-data="{ openHamburgerMenuModal: false }">
    @include("partials.button._modal-open")
    @include("partials._modal")
    <div class="flex items-center order-2 md:order-1 md:flex-1 flex-1 font-bold text-4xl cursor-default">
        <a href="/">
